    ...
    <div class="encuesta-modal-card">
        ...
        <div class="modal-body">
            ...
            <div class="step-content" data-step="3">
                ...
                <div class="action-footer">
                    <button class="btn-next btn-finish" onclick="EncuestaManager.next('final')">Finalizar</button>
                </div>
            </div>
            ...
            <div class="step-content" id="step-final">
                <div class="success-animation">
                    <div class="tugo-circle">
                        <img src="{{ asset('images/tugo-encuesta/tugo-pulgar-arriba.png') }}" alt="Success" onerror="this.style.display='none'">
                    </div>
                    <h2 class="final-title">¡Encuesta Completada!</h2>
                    
                    <p class="final-desc">
                        Tu opinión es muy valiosa para nosotros. Como agradecimiento, te regalaremos un cupón de descuento,
                    </p>
                </div>

                <div class="contact-form-premium" id="coupon-form">
                    <p style="margin-bottom: 10px; font-weight: 600; color: #185875;">Ingresa tu correo o número de contacto para recibir el cupón:</p>
                    <input type="text" placeholder="Ej: example@gmail.com o 98765432" class="premium-input contact-input" style="text-align: center;">
                    <button class="btn-redeem" onclick="EncuestaManager.submit()">Enviar</button>
                </div>
            </div>
...
<style>
    ...
    .btn-naranja-original {
        ...
        box-shadow: 0 6px 0 #FB8500; transition: transform 0.1s, box-shadow 0.1s;
    }
    .btn-naranja-original:hover { transform: translateY(4px); box-shadow: 0 2px 0 #FB8500; }
...
const EncuestaManager = (function() {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if(backer) backer.addEventListener('click', () => { next(1); });
    ...
    const overlay = document.getElementById('modal-encuesta-overlay');
    ...
    function next(step) {
        ...
        if(step === 'final') {
            const finalStep = modalContext.querySelector('#step-final');
            ...
            if(form) {
                setTimeout(() => form.classList.add('visible'), 300);
            }
        } else {
            ...
            const stepEl = modalContext.querySelector(`.step-content[data-step="${step}"]`);
            ...
            if(txt) txt.textContent = `${step}/3`;
        }
    }
    /* mensaje de notificacion del cupon*/
    function submit() {
        ...
        toast.innerHTML = `<span style="color:#2ecc71; font-size:1.2rem;">✔</span> <span>¡Gracias! Tu cupón ha sido enviado.</span>`;
