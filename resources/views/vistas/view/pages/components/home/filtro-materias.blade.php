<div class="parent">
    <div class="div1">
        ...
        <div class="filtro-content">
            <h3>Contabilidad</h3>
            <p>Contabilidad Intermedia, Gubernamental, Tributaria, de Costos.</p>
        </div>
    </div>
    <div class="div2">
        ...
        <div class="filtro-content">
            ...
            <p>Cálculo, Física, Mecánica Aplicada</p>
        </div>
    </div>
    <div class="div3">
        ...
        <div class="filtro-content">
            <h3>Química</h3>
            <p>Química de Soluciones, Cromatografía, Química de Alimentos.</p>
        </div>
    </div>
    <div class="div4">
        ...
        <div class="filtro-content">
            <h3>Programación</h3>
            <p>Teoría de la Computación, Python, Php, Java.
            </p>
        </div>
    </div>
    <div class="div5">
        ...
        <div class="filtro-content">
            <h3>Inglés</h3>
            <p>Expresiones Idiomáticas, Pronunciación, Escritura.</p>
        </div>
    </div>
    <div class="div6">
        ...
        <div class="filtro-content">
            <h3>Música</h3>
            <p>Composición, Lectura Musical, Acordes.</p>
        </div>
    </div>
</div>
