                    ...
                    <div class="form-group-wrap">
                        <div class="am-form-group-row">
                            <div class="form-group-half {{ $errors->get('first_name') ? 'am-invalid' : '' }}">
                                <label class="am-label-register" for="first_name">{{ __('auth.first_name') }}</label>
                                <x-text-input id="first_name" wire:model="first_name"
                                    placeholder="{{ __('auth.first_name') }}" type="text" autofocus
                                    autocomplete="name" />
                                <x-input-error field_name="first_name" />
                            </div>
                            <div class="form-group-half {{ $errors->get('last_name') ? 'am-invalid' : '' }}">
                                <label class="am-label-register" for="last_name">{{ __('auth.last_name') }}</label>
                                <x-text-input id="last_name" wire:model="last_name"
                                    placeholder="{{ __('auth.last_name') }}" type="text" autofocus />
                                <x-input-error field_name="last_name" />
                            </div>
                        </div>
                        <div class="form-group {{ $errors->get('email') ? 'am-invalid' : '' }}">
                            <label class="am-label-register" for="email">{{ __('auth.email_placeholder') }}</label>
                        ...
                        <div class="form-group @error('phone_number') am-invalid @enderror">
                            <label class="am-label-register" for="phone_number" class="am-important">{{
                                __('general.phone_number') }}</label>
                            <div class="form-control_wrap">
                                <x-text-input wire:model="phone_number" id="phone_number"
                                    placeholder="{{ __('general.enter_phone_number') }}" name="phone_number" type="text"
                        ...
                        <div class="form-group {{ $errors->get('password') ? 'am-invalid' : '' }}">
                            <label class="am-label-register" for="password">{{ __('auth.password_placeholder')
                                }}</label>
                        ...
                        <div class="form-group {{ $errors->get('password') ? 'am-invalid' : '' }}">
                            <label class="am-label-register" for="password_confirmation">{{
                                __('auth.confirm_password_placeholder') }}</label>
                            <div class="am-passwordfield">
                        ...
                        <div class="form-group">
                            <x-primary-button wire:target="register" wire:loading.class="am-btn_disable"><span>{{
                                    __('auth.register') }}</span><i class="icon icon-arrow-right"></i>
                            </x-primary-button>
                            <span class="am-already-account"> {{ __('auth.already_have_account') }} <a
                                    href="{{ route('login') }}">{{ __('auth.login') }}</a></span>
                        </div>
                    </div>
                </div>
        </form>
