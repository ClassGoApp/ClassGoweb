            ...
            <div class="modal-body bank-modal-body">
                <form wire:submit.prevent="updatePayout">
                    ...
                    <div class="form-group">
                        ...
                        <select style="padding:0rem 1rem  !important;" wire:model.blur="bankTitle" id="accounttitle" name="accounttitle"
                            class="form-control bank-input @error('bankTitle') is-invalid @enderror" required>
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model.blur="bankAccountNumber" id="account" name="account"
                            placeholder="Ingrese el número de cuenta" type="text"
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model.blur="bankName" id="bankname" name="bankname"
                            placeholder="Introduzca el nombre del banco" type="text"
