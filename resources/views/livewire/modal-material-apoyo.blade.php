    ...
    <div class="modal-ma-backdrop">
        <div class="modal-ma-container">
            ...
            <div class="modal-ma-header">
                <h2 class="modal-ma-title">Material de Apoyo</h2>
            ...
            <div class="modal-ma-body">
                ...
                <div class="modal-ma-info-box">
                    <strong>Nota:</strong> Es opcional adjuntar material de apoyo. Si no lo tienes ahora, puedes avanzar y adjuntarlo luego usando el botón <strong>"Adjuntar Material"</strong>.
                </div>
...
@media (max-width: 480px) {
    .modal-ma-backdrop { padding: 8px; }
    .modal-ma-container { max-height: 95vh; }
