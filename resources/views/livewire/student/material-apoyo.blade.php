                ...
                <div class="cg-ma-booking-list">
                    @forelse($slotBookings as $booking)
                        ...
                        >
                            ...
                            <h4 class="cg-ma-tutor">Tutor: {{ $this->UserData($booking->tutor_id)->first_name ?? 'ID ' . $booking->tutor_id }}</h4>
                            <p class="cg-ma-info">
                                ⏰ {{ \Carbon\Carbon::parse($booking->start_time)->format('H:i') }} - {{ \Carbon\Carbon::parse($booking->end_time)->format('H:i') }} hrs
            ...
            <main class="cg-ma-workspace">
                @if($selectedBooking)
                    ...
                    <div class="cg-ma-files-section">
                        ...
                        <div class="cg-ma-files-grid">
                            @if($selectedBooking->supporting_material)
                                @php
                                    ...
                                    $fileName = basename($selectedBooking->supporting_material);
                        ...
                        <p class="cg-ma-detail-title" style="width: 30%">Descripcion: 
                           <span style="padding: 5px"> {{ $selectedBooking->description ?? 'Sin descripción' }} </span>
                        </p>
